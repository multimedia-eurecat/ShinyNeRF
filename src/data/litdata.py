...
from src.data.data_util.shiny_blender_no_norm import load_shiny_blender_data_no_norm
from src.data.data_util.shiny_blender_bitangents import load_shiny_blender_data_bitangents
...
@gin.configurable(denylist=["datadir", "scene_name"])
class LitDataShinyBlenderRadius(LitData):
    def __init__(
        self,
        datadir: str,
        img_downscale: int,
        ...
        super(LitDataShinyBlenderRadius, self).__init__(datadir)
        self.white_bkgd = white_bkgd

@gin.configurable(denylist=["datadir", "scene_name"])
class LitDataShinyBlenderBitangentRadius(LitData):
    def __init__(
        self,
        datadir: str,
        img_downscale: int,
        ...
        (
            ...
            self.bitangents,
            self.distances,
        ) = load_shiny_blender_data_bitangents(
            datadir=datadir,
            img_downscale=img_downscale,
            scene_name=scene_name,
            train_skip=train_skip,
            ...
            white_bkgd=white_bkgd,
            radius=True,
            remove_alpha_rays=False,
        )

        super(LitDataShinyBlenderBitangentRadius, self).__init__(datadir)
        self.white_bkgd = white_bkgd


@gin.configurable(denylist=["datadir", "scene_name"])
class LitDataShinyBlenderNoNorm(LitData):
    def __init__(
        self,
        datadir: str,
        img_downscale: int,
        ...
        (
            ...
            (self.i_train, self.i_val, self.i_test, self.i_all),
            self.render_poses,
        ) = load_shiny_blender_data_no_norm(
            datadir=datadir,
            img_downscale=img_downscale,
            scene_name=scene_name,
            train_skip=train_skip,
        ...
        super(LitDataShinyBlenderNoNorm, self).__init__(datadir)
        self.white_bkgd = white_bkgd

@gin.configurable(denylist=["datadir", "scene_name"])
class LitDataShinyBlenderNoNormRadius(LitData):
    def __init__(
        self,
        datadir: str,
        img_downscale: int,
        ...
        super(LitDataShinyBlenderNoNormRadius, self).__init__(datadir)
        self.white_bkgd = white_bkgd
