...
from src.data.litdata import (
    ...
    LitDataRefNeRFReal,
    LitDataShinyBlender,
    LitDataShinyBlenderRadius,
    LitDataShinyBlenderBitangentRadius,
    LitDataShinyBlenderNoNorm,
    LitDataShinyBlenderNoNormRadius,
    LitDataTnT,
)
...
from src.model.shinynerf.model import LitShinyNeRF
...
def select_dataset(
    ...
    elif dataset_name == "shiny_blender_radius":
        data_fun = LitDataShinyBlenderRadius
    elif dataset_name == "shiny_blender_bitangent_radius":
        data_fun = LitDataShinyBlenderBitangentRadius 
    elif dataset_name == "shiny_blender_no_norm":
        data_fun = LitDataShinyBlenderNoNorm
    elif dataset_name == "shiny_blender_no_norm_radius":
        data_fun = LitDataShinyBlenderNoNormRadius
