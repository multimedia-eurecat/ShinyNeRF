...
if __name__ == "__main__":
    ...
    fid_mean, fid_train, fid_val, fid_test = [], [], [], [], []
    ...
    for json_file in json_list:
        ...
        fid_train.append(json_file["FID"]["train_mean"])
        fid_val.append(json_file["FID"]["val_mean"])
        fid_test.append(json_file["FID"]["test_mean"])
